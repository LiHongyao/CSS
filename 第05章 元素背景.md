...
- linear-gradient(black, white 20%, gray)
  ...
  inear-gradient(red 0%, white 20%, blue 100%)

  ![](IMGS/repeating-linear-gradient-2.png)

- linear-gradient(black 40%, white,  black, orange)

  相当于

  linear-gradient(black 40%, white 60%, black 80%, orange 100%)
...
- linear-gradient(black 20px, white 0, gray 40px);
